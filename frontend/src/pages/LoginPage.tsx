        ...
        <div className="bg-navy-800 rounded-2xl p-6 card-glow">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-navy-700 border border-slate-700 rounded-lg px-4 py-2.5 text-sm text-slate-300 focus:outline-none focus:border-accent transition pr-10"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full gradient-accent rounded-lg py-2.5 text-sm font-medium text-white hover:opacity-90 disabled:opacity-50 transition"
            >
